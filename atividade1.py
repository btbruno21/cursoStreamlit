...
with st.container():
    ...
    latas_leite_condensado = float(st.text_input("Quantidade de latas de leite condensado necessárias para a receita:", "1.0"))
    ...
    quantidade_ovos = float(st.text_input("Quantidade de ovos necessários para a receita:", "1.0"))
